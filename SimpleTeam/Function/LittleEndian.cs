...
namespace SimpleTeam.Function
{
    public class LittleEndian
    {
        ...
        public static short GetShort(byte[] bytes, int offset)
        {
            ...
            {
                //Add value.
                value |= (short)((bytes[offset + i] & 0xff) << (i * 8));
            }
            //Return value.
            return value;
        }

        public static void SetShort(byte[] bytes, int offset, int value)
        {
            //Set integer value.
            for (int i = 0; i < SizeOf.SHORT; i++)
            {
                //Set value.
                bytes[offset + SizeOf.SHORT - i - 1] = (byte)value;
                //Shift right.
                value >>= 8;
            }
        }
        ...
        public static void SetInteger(byte[] bytes, int offset, int value)
        {
            ...
            {
                //Set value.
                bytes[offset + SizeOf.INTEGER - i - 1] = (byte)value;
                //Shift right.
                value >>= 8;
            }
        }
        ...
        public static void SetLong(byte[] bytes, int offset, long value)
        {
            ...
            {
                //Set value.
                bytes[offset + SizeOf.LONG - i - 1] = (byte)value;
                //Shift right.
                value >>= 8;
            }
        }
